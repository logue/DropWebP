...
- **MozJPEG**：与传统 JPEG 相比，在相同文件大小下，它可以实现更高的图像质量，甚至可以在相同图像质量下实现更小的文件大小。
...
| 格式           | 主要优势                             | 适用场景                             | 有损 | 无损 | Alpha | 压缩比 | 加载 |
| -------------- | ------------------------------------ | ------------------------------------ | ---- | ---- | ----- | ------ | ---- |
| PNG (Zopfli)   | 无图像质量下降，背景透明。           | 徽标、图标、图表。                   | ❌️  | ✅️  | ✅️   | 中     | 高   |
| JPEG (MozJPEG) | 允许非常小的照片。                   | 网络上的普通照片。                   | ✅️  | ❌️  | ❌️   | 高     | 低   |
| WebP           | 高压缩比和高质量，支持透明度和动画。 | 网站的通用图像。                     | ✅️  | ✅️  | ✅️   | 中     | 中   |
| AVIF           | **最高压缩率和高质量**，支持广色域。 | 需要高质量和快速显示的网站。         | ✅️  | ❌️  | ✅️   | 高     | 高   |
| JPEG XL        | 终极格式，兼容一切和 JPEG。          | 适用于更小的 JPEG 和未来的图像统一。 | ✅️  | ✅️  | ✅️   | 高     | 低   |
