...
- **MozJPEG**：與傳統 JPEG 相比，在相同檔案大小下，它可以實現更高的影像質量，甚至可以在相同影像質量下實現較小的檔案大小。
...
| 格式           | 主要優點                             | 適用場景                             | 有損 | 無損 | Alpha | 壓縮比 | 載入 |
| -------------- | ------------------------------------ | ------------------------------------ | ---- | ---- | ----- | ------ | ---- |
| PNG (Zopfli)   | 無影像品質下降，背景透明。           | 徽標、圖標、圖表。                   | ❌️  | ✅️  | ✅️   | 中     | 高   |
| JPEG (MozJPEG) | 允許非常小的照片。                   | 網路上的普通照片。                   | ✅️  | ❌️  | ❌️   | 高     | 低   |
| WebP           | 高壓縮比和高品質，支援透明度和動畫。 | 網站的通用圖片。                     | ✅️  | ✅️  | ✅️   | 中     | 中   |
| AVIF           | **最高壓縮率和高品質**，支援廣色域。 | 需要高品質和快速顯示的網站。         | ✅️  | ❌️  | ✅️   | 高     | 高   |
| JPEG XL        | 終極格式，相容於一切和 JPEG。        | 適用於較小的 JPEG 和未來的影像統一。 | ✅️  | ✅️  | ✅️   | 高     | 低   |
