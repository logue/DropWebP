  ...
  <v-card :title="t('title')" flat>
    <v-card-text>
      <v-switch
        ...
        :hint="t('progressive_hint')"
        color="primary"
        persistent-hint
      >
        <template #label>
          {{ t('progressive') }}
          <v-chip :text="t('recommended')" size="x-small" />
        </template>
      </v-switch>
      <v-switch
        v-model="settingsStore.jpegOptions.optimize"
        :hint="t('optimize_hint')"
        :label="t('optimize')"
        color="primary"
        persistent-hint
      >
      ...
      <v-slider
        v-model="settingsStore.jpegOptions.quality"
        :hint="t('quality_hint')"
