    ...
    (0, vue_1.onMounted)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // バックエンドからのログメッセージを受信
                return [4 /*yield*/, (0, event_1.listen)('log-message', function (event) {
                        var logData = event.payload;
                        console.log("[".concat(logData.level.toUpperCase(), "] ").concat(logData.message, " (").concat(logData.timestamp, ")"));
